...
//
// CALYPSO NOTE: The only change made is to allow the same module to be
// defined across several module maps (esp. "c", which is the root for C
...
public:
  ...
  typedef ::clang::ModuleMap::ModuleHeaderRole ModuleHeaderRole;
  static const auto NormalHeader = ::clang::ModuleMap::NormalHeader;
  static const auto PrivateHeader = ::clang::ModuleMap::PrivateHeader;
  static const auto TextualHeader = ::clang::ModuleMap::TextualHeader;
