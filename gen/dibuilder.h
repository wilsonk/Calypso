...
private:
    ...
    void AddBaseFields(AggregateDeclaration *ad, ldc::DIFile file,
#if LDC_LLVM_VER >= 306
    ...
    DIType CreateMemberType(unsigned linnum, Type *type, DIFile file, const char* c_name, unsigned offset, PROT);
