...
import (C++) Qt.AlignmentFlag, QApplication, QString;
...
//         mainLayout.addWidget(cast(QWidget*) addressLabel, 1, 0/+, QFlags!AlignmentFlag(AlignmentFlag.AlignTop)+/);
...
//     addressBook.show();
    ...
    auto addressLabel = new QLabel(addressStr);
    auto addressText = new QTextEdit;
    ...
    addressBook.setLayout(cast(QLayout*) mainLayout);
    addressBook.setWindowTitle(titleStr);
    addressBook.show();
